...
# 原始数据样本、标签路径
anno_src = r"/Cebela/Anno/list_bbox_celeba.txt"
img_dir = r"Cebela/Img"

# 样本保存路径
save_path = r"/celeba_sample"

for face_size in [12]:

    print("gen %i data" % face_size)
    # 样本图片保存位置
    ...
    # 如果文件不存在则创建文件路径
    for dir_path in [positive_image_dir, negative_image_dir, positive_image_dir]:
